...
GLuint SetupPhase345DataForRendering()
{
  ...
  GLuint normals_vbo;    // Index buffer object
  glGenBuffers( 1, &normals_vbo);
  glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, normals_vbo );
  glBufferData( GL_ELEMENT_ARRAY_BUFFER, 77535 * sizeof(GLuint), tri_normals, GL_STATIC_DRAW );
...
const char *phase345FragmentShader =
  ...
  "if (1 < data && data < 4.5) {\n"
  "float t1 = (1.0 - 0.25) / (4.5 - 1);\n"
  "float f1 = 0.25 + (t1 * (data - 1));\n"
  "float t2 = (1.0 - 0.25) / (4.5 - 1);\n"
  ...
  "float f1 = 1.0 + (t1 * (data - 4.5));\n"
  "float t2 = (0.25 - 1) / (6 - 4.5);\n"
